...
{
    public class FeaComplianceObj : FeaObjective
    {
        public override void ApplyTo(FeaSolver solver, FeaSolverContext context)
        {
            solver.AddCompliance(Weight);
        }
    }

    public class ComplianceComponent : GH_Component
    {
        public ComplianceComponent()
            : base("FEA Compliance", "Compliance",
                "Minimize structural compliance (strain energy)",
        ...
        {
            pManager.AddGenericParameter("Objective", "Obj", "FEA compliance objective", GH_ParamAccess.item);
        }
