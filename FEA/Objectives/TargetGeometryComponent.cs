...
{
    public class FeaTargetGeometryObj : FeaNodeObjective
    {
        public List<Point3d> Targets { get; init; } = [];
        ...
        public override void ApplyTo(FeaSolver solver, FeaSolverContext context)
        {
            ...
            solver.AddTargetGeometry(Weight, indices, flat);
        }
    }

    public class TargetGeometryComponent : GH_Component
    {
        public TargetGeometryComponent()
            : base("FEA Target Geometry", "TgtGeom",
                "Target deformed positions at specific nodes",
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddPointParameter("Targets", "T", "Target deformed positions", GH_ParamAccess.list);
        ...
        {
            pManager.AddGenericParameter("Objective", "Obj", "FEA target geometry objective", GH_ParamAccess.item);
        }
