...
namespace Ariadne.Utilities
{
    ...
    public class UpdateCurves : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (network.Network.Graph.Edges.Count != guids.Count)
            {
                AddRuntimeMessage(GH_RuntimeMessageLevel.Error, "Length of GUIDs must match length of edges in network");
            }
